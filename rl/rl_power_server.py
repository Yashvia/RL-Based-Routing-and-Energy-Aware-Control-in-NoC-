...
SOCKET_PATH = "/tmp/booksim_rlpower.sock"   # separate from rl_mesh's socket
    ...
    for ep in range(N_EPISODES):
        ...
        if ep % EVAL_EVERY == 0:
            ...
            if avg_eval > agent.best_eval_score:
                ...
                agent.save("best_power_agent.pkl")
                print(f"  >> New best eval avg ({avg_eval:.4f}), saved to best_power_agent.pkl")
